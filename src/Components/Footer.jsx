            ...
            <div className="flex flex-wrap justify-around px-4">
                ...
                <div className="ml-5 gap-4">
                    ...
                    <p className="text-gray-600 text-sm">
                        Luxury Stay Hotel,<br />
                        456 Paradise Lane,<br />
                        Dream City, Comfort State, 12345
                    </p>
                    <p className="text-gray-600 text-sm mt-3">
                        Email: <a href="mailto:luxurystay@example.com" className="text-blue-500 underline">luxurystay@example.com</a>
                    </p>
                    {/* Social Links */}
